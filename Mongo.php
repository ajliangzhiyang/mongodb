...
class Mongo
{
    ...
    public function  insert($table,$document=array())
    {
        try{
     ...
     */
    public function batch_insert($table,$documents=array())
    {
        try{
    ...
    */
    public  function  update($table,$filter=array(),$options=array(),$condition=['multi' => true,'upsert' => false])
    {
        try{
